<template>
  <BaseForm :has-changed="props.hasChanged" :is-valid="props.isValid" :entity="props.genre" @update:entity="e => emits('update:genre', e)" @save="emits('save')" @cancel="emits('cancel')">
    <TextInput
        label="Nom"
...
const updateAttribute = (attribute: string, value: any) => {
  const newGenre: Genre = _.clone(props.genre);
